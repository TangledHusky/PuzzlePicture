...
//  Copyright (c) 2015年 yajun. All rights reserved.
//  侧边栏设置参数中心,菜单滑出距离设置在pch文件内
...
#define kMainPageDistance   (kScreenWidth-kLeftViewSlideDepth)   //打开左侧窗时，中视图(右视图)露出的宽度
...
#define vCouldChangeDeckStateDistance  kLeftViewSlideDepth / 2.0 - 40 //滑动距离大于此数时，状态改变（关--》开，或者开--》关）
